 ...
 */
public class SampleHttpServerHandler extends SimpleChannelInboundHandler<FullHttpRequest> {
    private static Logger LOG = LoggerFactory.getLogger(SampleHttpServerHandler.class);
    public static final String HTTP_DATE_FORMAT = "EEE, dd MMM yyyy HH:mm:ss zzz";
    public static final String HTTP_DATE_GMT_TIMEZONE = "GMT";

    final File staticRootDir;

    public SampleHttpServerHandler(final File staticRootDir) {
    ...
    public void channelRead0(ChannelHandlerContext ctx, FullHttpRequest request) throws Exception {
        ...
        try {
            SampleHttpServerController controller = new SampleHttpServerController(staticRootDir, request);
